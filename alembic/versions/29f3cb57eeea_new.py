...
Revision ID: 29f3cb57eeea
Revises: 
Create Date: 2023-06-27 00:17:30.534509
...
def upgrade() -> None:
    ...
    sa.Column('role', sa.Enum('admin', 'moderator', 'teacher', 'student', name='role'), nullable=True),
